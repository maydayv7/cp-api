...
export class Contests {
  ...
  async getByPlatform(
    platform: Platform,
    options?: Omit<FetchOptions, "platforms">,
  ): Promise<UnifiedContest[]> {
  ...
  async search(
    query: string,
    options?: Omit<FetchOptions, "keywords">,
  ): Promise<UnifiedContest[]> {
